...
<td><?php echo $row->emgcontactno;?></td>
...
<td colspan="2">
<?php echo $row->corressAddress;?><br />
<?php echo $row->corressCity;?>, <?php echo $row->corressPincode;?><br />
<?php echo $row->corressState;?>


</td>
<td><b>Permanent Address</b></td>
<td colspan="2">
<?php echo $row->permaAddress;?><br />
<?php echo $row->permaCity;?>, <?php echo $row->permaPincode;?><br />
<?php echo $row->permatState;?>	
