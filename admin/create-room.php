...
$roomno=$_POST['rmno'];
$fees=$_POST['fee'];
$sql="SELECT roomno FROM rooms where roomno=?";
...
{
$query="insert into  rooms(roomno,fees) values(?,?)";
...
{ ?>
<p style="color: red"><?php echo htmlentities($_SESSION['msg']); ?><?php echo htmlentities($_SESSION['msg']="Allocated Successfully"); ?></p>
<?php } ?>
