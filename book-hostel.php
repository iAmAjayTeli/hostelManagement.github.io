...
$query="insert into  registration(roomno,feespm,stayfrom,duration,course,regno,firstName,middleName,lastName,gender,contactno,emailid,emgContact,guardianName,guardianRelation,guardianContactno,corressAddress,corressCity,corressState,corressPincode,permaAddress,permaCity,permaState,permaPincode) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('iiisisissssisississsisss',$roomno,$feespm,$stayfrom,$duration,$course,$regno,$fname,$mname,$lname,$gender,$contactno,$emailid,$emcntno,$gurname,$gurrelation,$gurcntno,$caddress,$ccity,$cstate,$cpincode,$paddress,$pcity,$pstate,$ppincode);
$stmt->execute();
